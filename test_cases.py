...
# ====================================================
# TODO: Add more test cases for both Decision Tree and Random Forest within the box
# 2-D XOR data, 2-class (Different with matlab output)
# X_6 = test['X_5']
# y_6 = test['y_5']
# model = RandomForest()
# model.build(X_6, y_6)
# print('Correct Pred 2-D Random Forest, 2 class: {}'.format(np.allclose(model.predict(X_5), test['pred_5'])))
# ====================================================
