...
class DecisionTree:
    ...
    def _entropy(self, y):
        ...
        # Set the entropy of the unnormalized multinomial distribution counts
        # Make sure the case where p_i = 0 is handeled appropriately. 
        entropy =0
        for m in counts:
            # The P(X=x) value
            p_i = m/len(y) if len(y) else 0 
            if(p_i != 0):
                # Entropy
    ...
    def _find_split(self, X, y, H_data):
        ...
        # ("This is the split index ",split_dim)
        # print("This is the H_data ", H_data)
        ...
        # print("This is the X values", X)
        # print("This is the y values", y)
        # print("This is the unique value", unique_values)
        # print("This is the unique value", unique_values)
        # print("This is the first value",first_idxes)
        ...
        for ii in range(unique_values.shape[0] - 1):
            ...
            #print(X[:, split_dim]<= split_value
            current_split_index = first_idxes[ii+1]
            current_split_value = unique_values[ii]
            # 10
            N_j = N

            left = y[:current_split_index]
            right = y[current_split_index: N_j]
           ...
           # print("This is my Entropy left ",H_left,"Thi is my following left values", left)
           # print("This is my Entropy right ",H_right,"This is my folloing right values", right)

            current_information_gain = H_data - (N_l/N_j) * H_left - (N_r/N_j) * H_right
            if self.debug:
